...
public class GlobalExceptionHandler{
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(EmailAlreadyExistException e){
        return ApiResponseGenerator.fail(MemberErrorMessage.EMAIL_ALREADY_EXIST.getMessage(), HttpStatus.LOCKED);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(NicknameAlreadyExistException e){
        return ApiResponseGenerator.fail(MemberErrorMessage.NICKNAME_ALREADY_EXIST.getMessage(), HttpStatus.LOCKED);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException (UniversityCountException e){
        return ApiResponseGenerator.fail(MemberErrorMessage.WRONG_UNIVERSITY_COUNT.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(UniversitySelectionException e){
        return ApiResponseGenerator.fail(MemberErrorMessage.SELECTED_WRONG_UNIVERSITY.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(UniversityDuplicationException e){
        return ApiResponseGenerator.fail(MemberErrorMessage.SELECTED_DUPLICATED_UNIVERSITY.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(ParameterCountException e){
        return ApiResponseGenerator.fail(MemberErrorMessage.PARAMETER_COUNT_ERROR.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(PasswordMatchException e){
        return ApiResponseGenerator.fail(MemberErrorMessage.PASSWORD_NOT_MATCH.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(UnivNotExistException e){
        return ApiResponseGenerator.fail(UniversityErrorMessage.UNIV_NOT_EXIST.getMessage(), HttpStatus.NOT_FOUND);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(RegionNotExistException e){
        return ApiResponseGenerator.fail(UniversityErrorMessage.REGION_NOT_EXIST.getMessage(), HttpStatus.NOT_FOUND);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(FundingStartUnavailableException e){
        return ApiResponseGenerator.fail(FundingErrorMessage.FUNDING_START_DATE_UNAVAILABLE.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(FundingDurationUnavailableException e){
        return ApiResponseGenerator.fail(FundingErrorMessage.FUNDING_DURATION_UNAVAILABLE.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(FundingEstimateUnavailableException e){
        return ApiResponseGenerator.fail(FundingErrorMessage.FUNDING_ESTIMATE_DATE_UNAVAILABLE.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(FundingGoalMoneyException e){
        return ApiResponseGenerator.fail(FundingErrorMessage.FUNDING_GOAL_MONEY_UNAVAILABLE.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(FundingNotExistException e){
        return ApiResponseGenerator.fail(FundingErrorMessage.FUNDING_NOT_EXIST.getMessage(), HttpStatus.NOT_FOUND);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(PaymentUnavailableException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.PAYMENT_UNAVAILABLE.getMessage(), HttpStatus.FORBIDDEN);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(PaymentDurationException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.PAYMENT_DURATION_UNAVAILABLE.getMessage(), HttpStatus.FORBIDDEN);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(PaymentAlreadyDoneException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.PAYMENT_ALREADY_DONE.getMessage(), HttpStatus.FORBIDDEN);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(PaymentOptionNotExistException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.PAYMENT_OPTION_NOT_EXIST.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(QuantityNotEnoughException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.QUANTITY_NOT_ENOUGH.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(CoinNotEnoughException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.COIN_NOT_ENOUGH.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(HistoryNotExistException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.HISTORY_NOT_EXIST.getMessage(), HttpStatus.NOT_FOUND);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(HistoryForbiddenException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.HISTORY_FORBIDDEN.getMessage(), HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler(ForbiddenException.class)
    public ApiResponse<ApiResponse.CustomBody> handleForbiddenException(ForbiddenException e){
        return ApiResponseGenerator.fail(SecurityErrorMessage.FORBIDDEN_ERROR.getMessage(), HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler(UnAuthorizedException.class)
    public ApiResponse<ApiResponse.CustomBody> handleUnAuthorizedException(UnAuthorizedException e){
        return ApiResponseGenerator.fail(SecurityErrorMessage.UNAUTHORIZED_ERROR.getMessage(), HttpStatus.UNAUTHORIZED);
    }
    ...
    public ApiResponse<ApiResponse.CustomBody> handleIllegalStateException(UnAuthorizedException e){
        return ApiResponseGenerator.fail(PaymentErrorMessage.PAYMENT_TYPE_NOT_EXIST.getMessage(), HttpStatus.BAD_REQUEST);
    }
